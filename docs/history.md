...
a snapshot to skip the download was documented for a long time and never
worked: the snapshot directory did not exist, so the `rsync` failed and every
worktree downloaded anyway (#289).
