 ...
 *
 * <p>Half the stages leave no trace in a workspace. Those say so on the page and
...
public final class AnalysisReport {
     ...
     *
     * <p>The score is the one being <em>written</em> rather than the one on
     * disk: a caller that transposed or respelled it gets a page naming the same
     * chords its chart does.
     */
