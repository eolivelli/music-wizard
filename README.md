...
The engraved sheet drops any word it has no bar for — the bars span the harmony
rather than the song — and drops only that word; the text sheet prints every word
and is the one to read when the two differ.
