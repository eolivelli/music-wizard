...
public enum Provenance {
     ...
     * supplied value and the grid's own rate.
     *
     ...
     * grid is a coincidence: the shape proxy -- step two of
     ...
     * off its map and it reads the grid's own rate instead. Which segment the
