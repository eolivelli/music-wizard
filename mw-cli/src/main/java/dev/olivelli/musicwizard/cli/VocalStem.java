...
final class VocalStem {
     ...
     *         Every runtime failure, the decode's included, is remembered like
     *         the stem itself and rethrown, so the second stage in a run does
     *         not pay a whole-file decode and a model fetch to be told again
